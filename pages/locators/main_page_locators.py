...
class MainPageLocators:
    # Локатор для cookie
    COOKIES_ACCEPT_BUTTON = (By.CSS_SELECTOR, "button#rcc-confirm-button.App_CookieButton__3cvqF")
    ...
    TOP_ORDER_BUTTON = (By.CSS_SELECTOR, "button[class*='Button_Button__ra12g']")
    BOTTOM_ORDER_BUTTON = (By.CSS_SELECTOR, "div[class*='Home_FinishButton__1_cWm'] button")
